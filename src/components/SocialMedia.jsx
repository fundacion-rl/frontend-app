...
const SocialMedia = () => {
    return (
        <div className='div-SocialMedia' >
            ...
            <a href="https://twitter.com/FRetoLibertad" target="_blank" rel="noreferrer">
             <img src="http://drive.google.com/uc?export=view&id=1LQw5gMPfq-CIv8jPuatxbwNZuRxJwM7k" alt="twitterLogo" />
            </a>
            <a href="https://www.facebook.com/FRetoLibertad" target="_blank" rel="noreferrer">
             <img src="http://drive.google.com/uc?export=view&id=1C-xMvcgieswCSKhKJozriyc5cQBD4Y6-" alt="facebookLogo" />
            </a>
            <a href="https://www.instagram.com/fretolibertad" target="_blank" rel="noreferrer">
             <img src="http://drive.google.com/uc?export=view&id=1OA-_ji160eGYH_Nu-K5jkwTpCv250Vit" alt="instagramLogo" />
            </a>
            <a href="https://www.linkedin.com/company/fundaci%C3%B3n-retorno-a-la-libertad/about" target="_blank" rel="noreferrer">
